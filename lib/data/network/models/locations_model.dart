...
//
//     final locaModel = locaModelFromJson(jsonString);

import 'dart:convert';

LocaModel locaModelFromJson(String str) => LocaModel.fromJson(json.decode(str));

String locaModelToJson(LocaModel data) => json.encode(data.toJson());
...
class LocaModel {
  ...
  final dynamic error;
  final List<LocationsDatum> data;

  factory LocaModel.fromJson(Map<String, dynamic> json) => LocaModel(
        totalRecords: json["totalRecords"],
        succeeded: json["succeeded"],
        message: json["message"],
        error: json["error"],
        data: List<LocationsDatum>.from(
            json["data"].map((x) => LocationsDatum.fromJson(x))),
      );
